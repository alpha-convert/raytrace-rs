...
impl Triangle {
    pub fn new(a : Vector3<f64>, b : Vector3<f64>, c : Vector3<f64>, n : UnitVector3<f64>, mat : Arc<dyn Material>) -> Self {
        let bb1 = AABB::from_points(a,b);
        let bb2 = AABB::from_points(a,c);
        let bbox = AABB::union(&bb1, &bb2);
        Triangle { a: a, b: b, c: c, normal: n, bbox: bbox, mat }
    }
}
...
impl Geom for Triangle {
    fn intersect<'r>(&'r self, ray: Ray, i: Interval) -> Option<Intersection<'r>> {
        ...
        Some(Intersection::new(pt, t, self.normal, self.mat.as_ref(), ray, uv))
